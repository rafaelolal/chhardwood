...
export const metadata: Metadata = {
  title: "Gallery | CH Hardwood Floors",
  description:
    "View our gallery of hardwood flooring installations, refinishing, sanding, and repair services. CH Hardwood Floors serves the Tri-State Area.",
  keywords:
...
export default function Gallery() {
  ...
  return (
    <main>
      <section className="row w-100 m-0 py-5 wood-bg-2 border-bottom border-top border-light border-3">
      ...
      <section className="container mt-5 mb-4 d-flex justify-content-center">
        <blockquote
        ...
        >
          <div style={{ padding: "16px" }}>
            <a
              href="https://www.instagram.com/ch_hardwoodfloors/?utm_source=ig_embed&utm_campaign=loading"
              style={{
                background: "#FFFFFF",
                lineHeight: 0,
                padding: 0,
